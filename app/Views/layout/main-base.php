...
<head>
    ...
    <title><?= esc($title ?? 'Infomedia Dashboard') ?></title>
    ...
    <script src="<?php echo base_url('assets/js/fontawesome.min.js'); ?>" crossorigin="anonymous"></script> -->
    <!-- fontawesome cdn -->
    ...
    <style>
        ...
        .bg-gradient-primary {
            background: linear-gradient(60deg, #c5040c 0%, #fc8f06 100%) !important;
        }

        .btn-primary {
            background-color: #f40814 !important;
        }
...
<body class="g-sidenav-show   bg-gray-100">
    <div class="min-height-300 bg-primary position-absolute w-100" style="background: linear-gradient(90deg, #c5040c 0%, #fc8f06 100%);"></div>
