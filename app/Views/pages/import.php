    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-9">
            <div class="card shadow border-0">
                <div class="card-header bg-gradient-dark text-white pb-3">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div class="alert alert-warning bg-gradient-dark text-white mb-3">
                    ...
                    <form action="<?= base_url('import/upload') ?>" method="post" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control border border-primary" id="file" name="file" accept=".xlsx,.xls,.csv" required>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary" id="uploadBtn"><i class="fas fa-upload me-1"></i>Upload & Import</button>
                            <a href="<?= base_url('import/template') ?>" class="btn btn-outline-secondary"><i class="fas fa-download me-1"></i>Download Template</a>
                        </div>
                    </form>
